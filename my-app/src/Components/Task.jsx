...
const Task = () => {
  ...
  const events = [
    ...
    {
        title: "recreate the google form ",
        time: "11:00 11/03/23 ",
        details: "Admin",
      ...
      {
        title: "School Trust",
        time: "facing problem in payment gatway",
        details: "Member",
  ...
  return (
    ...
    <div className=' pt-4 px-4 '>
      ...
      <Link to='/'><li className="text-center py-2 px-4">Home</li></Link>
          ...
          <Link to='/Task'><li className="bg-blue-500 text-white py-2 px-4 rounded-lg text-center">Tasks</li></Link>
        </ul>
        {/* followers */}
      ...
      <h2 className="text-lg  mb-4">Task List</h2>
      <div>
        <span className='pr-3'>Pending</span>
      <button className='bg-red-500 px-3 py-2 text-white rounded-l-lg'>24 </button>
      <button className='bg-green-700 px-3 py-2 text-white rounded-r-lg'>31</button>
      <span className='pl-3'>Completed</span>
      </div>
      <button className="bg-blue-500 text-white px-4 py-0 text-[12px] rounded-md">Add Task</button>
      </div>
      <ul>
     ...
     >
       ...
       <div className="flex items-center">
         <input type="checkbox" id={`checkbox-${index}`} value="Bike" />
