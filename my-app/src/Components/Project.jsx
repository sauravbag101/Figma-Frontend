  ...
  return (
    ...
    <div className=' pt-4 px-4 '>
      ...
      <Link to='/'><li className="text-center py-2 px-4">Home</li></Link>
          ...
          <Link to='/Project'><li className="bg-blue-500 text-white py-2 px-4 rounded-lg text-center">Project</li></Link>
      ...
      <div className='w-[755px] h-[570px] bg-white rounded-lg  shadow-md ml-[16px] p-3 mt-2 '>
