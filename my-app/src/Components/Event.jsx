...
const Event = () => {
  ...
  const events = [
    {
      title: "Youth panel",
      time: "13:00 02/03/23 - 14:30 3/04/23",
    ...
    {
      title: "Walking World panel",
      time: "13:00 02/03/23 - 14:30 3/04/23",
      details: "1 manager, 0 Worker, 0 Guests",
    },
    {
      title: "Open Fest panel",
      time: "13:00 02/03/23 - 14:30 3/04/23",
      details: "1 manager, 0 Worker, 0 Guests",
    },
    {
      title: "Mukherjee panel",
      time: "13:00 02/03/23 - 14:30 3/04/23",
      details: "1 manager, 0 Worker, 0 Guests",
    },
    {
  ...
  return (
    ...
    <div className=' pt-4 px-4 '>
      ...
      <ul className="space-y-4">
          ...
          <Link to='/Event'><li className="bg-blue-500 text-white py-2 px-4 rounded-lg text-center">Event</li></Link>
      ...
      <div className="">
      <h2 className="text-lg  mb-4">Modelling Events</h2>
      <ul>
