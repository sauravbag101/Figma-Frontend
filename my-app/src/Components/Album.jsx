  ...
  return (
    ...
    <div className=' pt-4 px-4 '>
      ...
      <Link to='/'><li className="text-center py-2 px-4">Home</li></Link>
          ...
          <Link to='/Album'><li className="bg-blue-500 text-white py-2 px-4 rounded-lg text-center">Album</li></Link>
