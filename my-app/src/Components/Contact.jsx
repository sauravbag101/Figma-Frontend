  ...
  const events = [
    {
      title: "A11 Frank",
      time: "14:30 02/06/23 ",
      details: "1 manager, 0 Worker, 0 Guests",
  ...
  return (
    ...
    <div className=' pt-4 px-4 '>
      ...
      <Link to='/'><li className="text-center py-2 px-4">Home</li></Link>
          ...
          <Link to='/Contact'><li className="bg-blue-500 text-white py-2 px-4 rounded-lg text-center">Contact</li></Link>
      ...
      <h2 className="text-lg  mb-4">Contact List</h2>
      <button className="bg-blue-500 text-white px-4  text-[12px] rounded-md">Add Contact</button>
      </div>
      <ul>
